  ...
  async function handleSubmit() {
    ...
    try {
      const planData = {
        ...
        selectedDifficulty,
        prompt,
        gender: settings.settings.gender || undefined,
        age: settings.settings.age || undefined,
        weight: settings.settings.weight || undefined,
        height: settings.settings.height || undefined,
        benchpressPR: settings.settings.benchpressPR || undefined,
        squatPR: settings.settings.squatPR || undefined,
        deadliftPR: settings.settings.deadliftPR || undefined,
        pullUpsPR: settings.settings.pullUpsPR || undefined,
        weightUnit,
      };
